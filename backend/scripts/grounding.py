...
def ground_phrases(
    ...
    _load()
    box_threshold = _CFG["box_threshold"] if box_threshold is None else box_threshold
    text_threshold = _CFG["text_threshold"] if text_threshold is None else text_threshold
